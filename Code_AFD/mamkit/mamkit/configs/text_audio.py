...
class MulTAConfig(BaseConfig):
    configs = {
        ...
        ConfigKey(dataset='mmused-fallacy', input_mode=InputMode.TEXT_AUDIO, task_name='afd',
                  tags={'anonymous'}): 'mmused_fallacy_afd_anonymous',
        ConfigKey(dataset='mmused-fallacy', input_mode=InputMode.TEXT_AUDIO, task_name='afd',
                  tags={'anonymous', 'jointattention'}): 'mmused_fallacy_afd_anonymous_jk',
    ...
    def mmused_fallacy_afd_anonymous(
        ...
        return cls(
            ...
            text_embedding_dim=768,
            loss_function=lambda: th.nn.CrossEntropyLoss(
                weight=th.Tensor([0.53858521, 6.97916667])),
            batch_size=4,
            num_classes=2,
            audio_model_args={},
            processor_args={},
    ...
    # changed: new joint attention config
    @classmethod
    def mmused_fallacy_afd_anonymous_jk(
            cls
    ):
        return cls(
            head=lambda: th.nn.Sequential(
