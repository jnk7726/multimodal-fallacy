...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused-fallacy', 'afd', 'text_audio_jointa')
    ...
    for seed in config.seeds:
        ...
        for split_info in loader.get_splits(key='mancini-et-al-2024'):
            ...
            split_info.train = remove_bias_tokens(split_info.train, banned_words)
            ...
            model = MAMKitLightingModel(model=model,
                                        ...
                                        val_metrics=MetricCollection({'f1': F1Score(task='multiclass', num_classes=2)}),
