...
from mamkit.models.text_audio import MulTA_VISUAL
from mamkit.utility.callbacks import PycharmProgressBar
from mamkit.utility.model import MAMKitLightingModel

if __name__ == '__main__':
    logging.basicConfig(level=logging.INFO)
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'mmused-fallacy', 'afc', 'text_audio_multa_visual')
    ...
    for seed in config.seeds:
        ...
        for split_info in loader.get_splits(key='mancini-et-al-2024'):
            ...
            train_dataloader = DataLoader(split_info.train, batch_size=config.batch_size, shuffle=True, collate_fn=collator)
